...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "tasks.db";   // table name need not be the same as database name???
    ...
    public ArrayList<Task> getTasks() {
        ...
        if (cursor.moveToFirst()) {
            do {
                int id = cursor.getInt(0); // get column must be integer // the index refers to the order of the column
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        // for version change
        // e.g. to add a new column, do "ALTER"
